...
The equality defined in \[eq:distributivity-serialization\]{reference-type="ref+label" reference="eq:distributivity-serialization"} means that the following diagram commutes:
