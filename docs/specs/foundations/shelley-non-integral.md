# Non-Integral Calculations {#sec:non-integr-calc}
...
## Types of Non-Integral Calculations {#sec:types-non-integral}

The specification employs non-integral calculations for different mathematical operations. Table [1](#tab:func-non-integral){reference-type="ref" reference="tab:func-non-integral"} shows the function and transition rules that use non-integral calculations and which type.

::: {#tab:func-non-integral}
...
## Implementation of Non-Integer Calculations {#sec:impl-non-integ}
...
### Function Simplification {#sec:funct-simpl}
...
### Properties of Function Approximation {#sec:prop-funct-appr-1}
