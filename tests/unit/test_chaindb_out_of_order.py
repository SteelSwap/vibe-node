...
class TestOutOfOrderArrival:
    ...
    def test_successor_arrives_before_predecessor(self, tmp_path):
    ...
    def test_multiple_successors_picks_longest(self, tmp_path):
    ...
    def test_unreachable_block_stored_but_no_switch(self, tmp_path):
    ...
    def test_sibling_chain_picked_when_longer(self, tmp_path):
